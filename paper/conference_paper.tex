...
\begin{itemize}
    ...
    \item \textbf{High-Res Patch (Ours):} \textbf{0.85 Dice}.
\end{itemize}
...
\hline
\textbf{Ours (Supervised - High/Res)} & 2025 & $\mathbf{84.89 \pm 1.2}$ \\
\textbf{Ours (Mean Teacher - 50\%)} & 2025 & $82.92 \pm 1.8$ \\
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{vis_error_combined.png}}
\caption{Qualitative Results and Error Analysis (Cases 001, 004, 006). Columns from left to right: (1) Original CT Slice, (2) Ground Truth Mask (Green), (3) Mean Teacher Prediction (Red), and (4) Error Analysis Map where \textcolor{green}{Green=True Positive}, \textcolor{red}{Red=False Positive}, and \textcolor{blue}{Blue=False Negative}. This detailed breakdown shows that our method captures the main pancreatic body (Green) with high accuracy, while errors are confined to subtle boundary regions.}
\label{fig:vis}
\end{figure}
